  ...
  export default {
  	...
  	mounted() {
  		this.renderClusterChart(
  			this.benadirDisbursementClusterData,
  			'Benadir: Project Disbursements by Pillar, 2016-18',
  			'project-disbursements'
  		);

  		this.renderClusterChart(
  			this.benadirPeacePoliticsSecurityClusterData,
  			'Benadir: Peace, Inclusive Politics, Security and Rule of Law',
  			'peace-security'
  		);

  		this.renderClusterChart(
  			this.benadirInstititionsClusterData,
  			'Benadir: Effective, Efficient Institutions',
  			'institutions'
  		);

  		this.renderClusterChart(
  			this.benadirEconomicClusterData,
  			'Benadir: Economic Growth',
  			'economic-growth'
  		);

  		this.renderClusterChart(
  			this.benadirInfrastructureClusterData,
  			'Benadir: Infrastructure',
  			'infrastructure'
  		);

  		this.renderClusterChart(
  			this.benadirSocialHumanDevClusterData,
  			'Benadir: Social & Human Development',
  			'social-human'
  		);

  		this.renderClusterChart(
  			this.benadirResilienceClusterData,
  			'Benadir: Resilience',
  			'resilience'
  		);
  	},
