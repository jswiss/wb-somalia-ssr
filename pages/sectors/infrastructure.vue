  		...
  		return {
  			...
  			infrastructureData: [
  				...
  				[
  					...
  					formatMillion(18076515),
  				],
  				['Mix of implementers\n - no government', formatMillion(0)],
